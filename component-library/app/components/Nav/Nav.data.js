...
export const withChildren = {
    ...
    currentId: 'vertical-231',
    items: [
        {id: 'vertical-1', title: 'Länktext', url: '#'},
        {id: 'vertical-2', title: 'Länktext &#038; Länktext', url: '#', isParentActive: true, children: [
            {id: 'vertical-21', title: 'Länktext', url: '#'},
            {id: 'vertical-22', title: 'Länktext &#038; Länktext', url: '#'},
            {id: 'vertical-23', title: 'Extern länk', url: 'https://test.se', isParentActive: true, children: [
                {id: 'vertical-231', title: 'Länktext', url: '#', isParentActive: true, children: [
                ...
                {id: 'vertical-232', title: 'Länktext &#038; Länktext', url: '#'},
